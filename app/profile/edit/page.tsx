...
import { ArrowLeft, Save, User, MapPin, Building, CreditCard } from 'lucide-react';
        ...
        <div className="bg-white border border-neutral-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-8 border-t border-neutral-200">
              ...
              <div className="space-y-6">
                <div>
                  <label htmlFor="accountHolder" className="block text-sm font-medium text-neutral-700 mb-2">
                    Titulaire du compte
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.iban}
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-neutral-300 focus:border-[#4B2377] focus:outline-none transition-colors font-mono"
                    placeholder="FR76 1234 5678 9012 3456 7890 123"
                  />
                </div>

                <div>
                  <label htmlFor="bic" className="block text-sm font-medium text-neutral-700 mb-2">
                    BIC / SWIFT
                  </label>
                  <input
                    type="text"
                ...
                <div className="bg-blue-50 border border-blue-200 p-4">
                  ...
                  <p className="text-sm text-blue-800 leading-relaxed">
                    Vos informations bancaires sont cryptées et sécurisées. Elles ne seront utilisées que pour les transactions liées à votre compte.
                  </p>
                </div>
              </div>
            </div>
